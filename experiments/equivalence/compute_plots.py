...
syspath = 'nn_32-32-32+df_4'

fig = plt.figure()
ax = fig.add_subplot(1, 1, 1)
ax.set_title(f'NN / RF equivalence')
...
for part in partitioning:
    ...
    for epsilon in epsilons:
        ...
        expstr = f'{epsilon}_{K}_666'
        expstr += f'_{part}_ibp'
        resstr = f'results_{syspath}_{expstr}.json'
...
plt.savefig(f"plot_equiv{iscum}.{EXTENSION}", bbox_inches="tight")
plt.show()
#plt.clf()
plt.close()
